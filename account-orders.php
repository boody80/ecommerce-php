          ...
          <div class="modal-content">
            ...
            <div class="modal-body pb-0">
              ...
              <div class="d-sm-flex justify-content-between mb-4 pb-3 pb-sm-2 border-bottom">
                <div class="d-sm-flex text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.php" style="width: 10rem;"><img src="img/shop/cart/01.jpg" alt="Product"></a>
              ...
              <div class="d-sm-flex justify-content-between my-4 pb-3 pb-sm-2 border-bottom">
                <div class="d-sm-flex text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.php" style="width: 10rem;"><img src="img/shop/cart/02.jpg" alt="Product"></a>
                  <div class="ps-sm-4 pt-2">
              ...
              <!-- Item-->
              <div class="d-sm-flex justify-content-between my-4 pb-3 pb-sm-2 border-bottom">
                <div class="d-sm-flex text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.php" style="width: 10rem;"><img src="img/shop/cart/03.jpg" alt="Product"></a>
                  <div class="ps-sm-4 pt-2">
              ...
              <div class="d-sm-flex justify-content-between my-4">
                <div class="d-sm-flex text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.php" style="width: 10rem;"><img src="img/shop/cart/04.jpg" alt="Product"></a>
                  <div class="ps-sm-4 pt-2">
        ...
        <div class="row">
            ...
            <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
              ...
              <div class="d-lg-block collapse" id="account-menu">
                ...
                <ul class="list-unstyled mb-0">
                  <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-orders.php"><i class="ci-bag opacity-60 me-2"></i>Orders<span class="fs-sm text-muted ms-auto">1</span></a></li>
          ...
          <section class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center pt-lg-2 pb-4 pb-lg-5 mb-lg-3">
              ...
              </div><a class="btn btn-primary btn-sm d-none d-lg-inline-block" href="account-signin.php"><i class="ci-sign-out me-2"></i>Sign out</a>
            </div>
            <!-- Orders list-->
