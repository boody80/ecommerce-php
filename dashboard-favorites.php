...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Favorites</title>
    <!-- SEO Meta Tags-->
          ...
          <div class="row">
              ...
              <div class="h-100 border-end mb-2">
                <div class="d-lg-block collapse" id="account-menu">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="dashboard-favorites.php"><i class="ci-heart opacity-60 me-2"></i>Favorites<span class="fs-sm text-muted ms-auto">4</span></a></li>
                  </ul>
                  <div class="bg-secondary p-4">
            ...
            <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
              <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block position-relative mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th06.jpg" alt="Product"><span class="btn btn-icon btn-danger position-absolute top-0 end-0 py-0 px-1 m-2" data-bs-toggle="tooltip" title="Remove from Favorites"><i class="ci-trash"></i></span></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Project Devices Showcase (PSD)</a></h3>
                    <div class="d-inline-block text-accent">$18.<small>00</small></div><a class="d-inline-block text-accent fs-ms border-start ms-2 ps-2" href="marketplace-vendor.php">by pixels</a>
                    <div class="d-sm-flex align-items-center pt-2">
                      <select class="form-select form-select-sm my-1 me-2">
                        <option>Standard license</option>
                        <option>Extended license</option>
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block position-relative mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th01.jpg" alt="Product"><span class="btn btn-icon btn-danger position-absolute top-0 end-0 py-0 px-1 m-2" data-bs-toggle="tooltip" title="Remove from Favorites"><i class="ci-trash"></i></span></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Top View Smartwatch 3D Render</a></h3>
                    <div class="d-inline-block text-accent">$19.<small>00</small></div><a class="d-inline-block text-accent fs-ms border-start ms-2 ps-2" href="marketplace-vendor.php">by modello</a>
                    <div class="d-sm-flex align-items-center pt-2">
                      <select class="form-select form-select-sm my-1 me-2">
                        <option>Standard license</option>
                        <option>Extended license</option>
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center pt-4 pb-2"><a class="d-block position-relative mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th07.jpg" alt="Product"><span class="btn btn-icon btn-danger position-absolute top-0 end-0 py-0 px-1 m-2" data-bs-toggle="tooltip" title="Remove from Favorites"><i class="ci-trash"></i></span></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Gravity Devices UI Mockup (PSD)</a></h3>
                    <div class="d-inline-block text-accent">$15.<small>00</small></div><a class="d-inline-block text-accent fs-ms border-start ms-2 ps-2" href="marketplace-vendor.php">by pixels</a>
                    <div class="d-sm-flex align-items-center pt-2">
                      <select class="form-select form-select-sm my-1 me-2">
                        <option>Standard license</option>
                        <option>Extended license</option>
