          ...
          <table class="table table-bordered table-layout-fixed fs-sm" style="min-width: 45rem;">
            <thead>
              <tr>
                ...
                <td class="text-center px-4 pb-4"><a class="btn btn-sm d-block w-100 text-danger mb-2" href="#"><i class="ci-trash me-1"></i>Remove</a><a class="d-inline-block mb-3" href="shop-single-v2.php"><img src="img/shop/comparison/01.jpg" width="80" alt="Apple iPhone Xs Max"></a>
                  <h3 class="product-title fs-sm"><a href="shop-single-v2.php">Apple iPhone Xs Max</a></h3>
                  <button class="btn btn-primary btn-sm" type="button">Add to Cart</button>
                </td>
                <td class="text-center px-4 pb-4"><a class="btn btn-sm d-block w-100 text-danger mb-2" href="#"><i class="ci-trash me-1"></i>Remove</a><a class="d-inline-block mb-3" href="shop-single-v2.php"><img src="img/shop/comparison/02.jpg" width="80" alt="Google Pixel 3 XL"></a>
                  <h3 class="product-title fs-sm"><a href="shop-single-v2.php">Google Pixel 3 XL</a></h3>
                  <button class="btn btn-primary btn-sm" type="button">Add to Cart</button>
                </td>
                <td class="text-center px-4 pb-4"><a class="btn btn-sm d-block w-100 text-danger mb-2" href="#"><i class="ci-trash me-1"></i>Remove</a><a class="d-inline-block mb-3" href="shop-single-v2.php"><img src="img/shop/comparison/03.jpg" width="80" alt="Samsung Galaxy S10+"></a>
                  <h3 class="product-title fs-sm"><a class="comparison-item-title" href="shop-single-v2.php">Samsung Galaxy S10+</a></h3>
                  <button class="btn btn-primary btn-sm" type="button">Add to Cart</button>
                </td>
              </tr>
            </thead>
