...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | My payment methods</title>
    <!-- SEO Meta Tags-->
        ...
        <div class="row">
            ...
            <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
              ...
              <div class="d-lg-block collapse" id="account-menu">
                ...
                <ul class="list-unstyled mb-0">
                  ...
                  <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-payment.php"><i class="ci-card opacity-60 me-2"></i>Payment methods</a></li>
          ...
          <section class="col-lg-8">
            ...
            <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-3">
              <h6 class="fs-base text-light mb-0">Primary payment method is used by default</h6><a class="btn btn-primary btn-sm" href="account-signin.php"><i class="ci-sign-out me-2"></i>Sign out</a>
            </div>
