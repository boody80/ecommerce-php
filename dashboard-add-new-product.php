              ...
              <div class="h-100 border-end mb-2">
                <div class="d-lg-block collapse" id="account-menu">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="dashboard-add-new-product.php"><i class="ci-cloud-upload opacity-60 me-2"></i>Add New Product</a></li>
