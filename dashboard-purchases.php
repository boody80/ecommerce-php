...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Purchases</title>
    <!-- SEO Meta Tags-->
          ...
          <div class="row">
              ...
              <div class="h-100 border-end mb-2">
                <div class="d-lg-block collapse" id="account-menu">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="dashboard-purchases.php"><i class="ci-basket opacity-60 me-2"></i>Purchases</a></li>
            ...
            <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
              <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
                ...
                <!-- Products list-->
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th01.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Top View Smartwatch 3D Render</a></h3>
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th02.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">UI Isometric Devices Pack (PSD)</a></h3>
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th03.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Cartzilla - Multipurpose E-Commerce Template</a></h3>
                    <div class="text-accent fs-sm mb-1">Standard license</div>
                    <div class="form-check d-table text-start mx-auto mx-sm-0">
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th04.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Hardcover Book Catalog Mockup (PSD)</a></h3>
                    <div class="text-accent fs-sm mb-1">Standard license</div>
                    <div class="form-check d-table text-start mx-auto mx-sm-0">
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th05.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Photo of Business Meeting</a></h3>
                    <div class="text-accent fs-sm mb-1">Standard license</div>
                    <div class="form-check d-table text-start mx-auto mx-sm-0">
