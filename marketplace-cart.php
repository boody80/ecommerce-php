            ...
            <section class="col-lg-8 pt-2 pt-lg-4 pb-4 mb-3">
              <div class="pt-2 px-4 pe-lg-0 ps-xl-5">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center border-bottom pb-3">
                  <div class="py-1"><a class="btn btn-outline-accent btn-sm" href="marketplace-category.php"><i class="ci-arrow-left me-1 ms-n1"></i>Back to shopping</a></div>
                  <div class="d-none d-sm-block py-1 fs-sm">You have 3 products in your cart</div>
                  <div class="py-1"><a class="btn btn-outline-danger btn-sm" href="marketplace-category.php"><i class="ci-close fs-xs me-1 ms-n1"></i>Clear cart</a></div>
                </div>
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block position-relative mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th02.jpg" alt="Product"><span class="btn btn-icon btn-danger position-absolute top-0 end-0 py-0 px-1 m-2" data-bs-toggle="tooltip" title="Remove from Favorites"><i class="ci-trash"></i></span></a>
                  <div class="text-center text-sm-start">
                    ...
                    <div class="d-inline-block text-accent">$23.<small>00</small></div><a class="d-inline-block text-accent fs-ms border-start ms-2 ps-2" href="#">by uidesigner</a>
                ...
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block position-relative mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th06.jpg" alt="Product"><span class="btn btn-icon btn-danger position-absolute top-0 end-0 py-0 px-1 m-2" data-bs-toggle="tooltip" title="Remove from Favorites"><i class="ci-trash"></i></span></a>
                  <div class="text-center text-sm-start">
                    ...
                    <div class="d-inline-block text-accent">$18.<small>00</small></div><a class="d-inline-block text-accent fs-ms border-start ms-2 ps-2" href="#">by pixels</a>
                    <div class="form-inline pt-2">
                      <select class="form-select form-select-sm my-1 me-2">
                        <option>Standard license</option>
                        <option>Extended license</option>
                ...
                <div class="d-block d-sm-flex align-items-center pt-4 pb-2"><a class="d-block position-relative mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th07.jpg" alt="Product"><span class="btn btn-icon btn-danger position-absolute top-0 end-0 py-0 px-1 m-2" data-bs-toggle="tooltip" title="Remove from Favorites"><i class="ci-trash"></i></span></a>
                  <div class="text-center text-sm-start">
                    ...
                    <div class="d-inline-block text-accent">$15.<small>00</small></div><a class="d-inline-block text-accent fs-ms border-start ms-2 ps-2" href="#">by pixels</a>
                    <div class="form-inline pt-2">
                      <select class="form-select form-select-sm my-1 me-2">
                        <option>Standard license</option>
                        <option>Extended license</option>
            ...
            <aside class="col-lg-4 ps-xl-5">
              ...
              <div class="p-4 h-100 ms-auto border-start">
                <div class="px-lg-2">
                  ...
                  </div><a class="btn btn-primary btn-shadow d-block w-100 mt-4" href="marketplace-checkout.php"><i class="ci-locked fs-lg me-2"></i>Secure Checkout</a>
