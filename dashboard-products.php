...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Products</title>
    <!-- SEO Meta Tags-->
          ...
          <div class="row">
              ...
              <div class="h-100 border-end mb-2">
                <div class="d-lg-block collapse" id="account-menu">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="dashboard-products.php"><i class="ci-package opacity-60 me-2"></i>Products<span class="fs-sm text-muted ms-auto">5</span></a></li>
            ...
            <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
              <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th08.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Flat-line E-Commerce Icons (AI)</a></h3>
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th09.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Square Style Mobile UI Kit (Sketch)</a></h3>
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th10.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Floating Phone and Tablet Mockup (PSD)</a></h3>
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th11.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Minimal Mobile App UI Kit (Sketch)</a></h3>
                ...
                <!-- Product-->
                <div class="d-block d-sm-flex align-items-center pt-4 pb-2"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.php" style="width: 12.5rem;"><img class="rounded-3" src="img/marketplace/products/th12.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    <h3 class="h6 product-title mb-2"><a href="marketplace-single.php">Travel &amp; Landmark Icon Pack (AI)</a></h3>
